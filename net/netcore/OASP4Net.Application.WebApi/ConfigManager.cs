...
namespace OASP4Net.Application.WebApi
{
    public class ConfigManager
    {
        ...
        private static bool UseVisualStudioIde = true;
        ...
        public static string ApplicationPath
        {
            get
            {
                if (UseVisualStudioIde) return Directory.GetCurrentDirectory();// + @"/Application/WebApi/";
                return Directory.GetCurrentDirectory() + @"/OASP4Net.Application.WebApi/";
            }
        }
